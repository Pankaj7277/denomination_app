...
class _HomepageState extends State<Homepage> {
  ...
  void updateTotalAmount() {
    ...
    setState(() {
      totalAmount = total;
      amountInWords =
          capitalizeFirstLetter(NumberToWordsEnglish.convert(totalAmount));
    });
  }
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                try {
                  final List<Map<String, dynamic>> storedData = storage
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          image:
                              AssetImage("assets/images/currency_banner.jpg"),
                          fit: BoxFit.cover)),
                  child: Align(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              setState(() {
                                counts[denomination] = int.tryParse(value) ?? 0;
                                updateTotalAmount();
                              });
                            },
                          ),
